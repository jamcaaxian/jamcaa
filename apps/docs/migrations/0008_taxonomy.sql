...
VALUES
	('jamcaa-default-category', 'General', 'general');

--> statement-breakpoint
ALTER TABLE `post` ADD `category_id` text REFERENCES category (id);

--> statement-breakpoint
UPDATE `post`
SET
	`category_id` = 'jamcaa-default-category'
WHERE
	`category_id` IS NULL;
